...
| Adoption-artifact evidence and fixture representation | Project Runtime Contracts release maintainer | [`AdoptionBaselineManifest.ts`](../src/protocol/AdoptionBaselineManifest.ts), [`fixtures/adoption-v1`](../fixtures/adoption-v1), and [ADR-0005](./decisions/ADR-0005-adoption-baseline-release-classification.md) | The repository owns the evidence shape and canonical fixtures. A generated record reports measured package facts; it does not register a runtime, publish a release, or claim downstream adoption. |
